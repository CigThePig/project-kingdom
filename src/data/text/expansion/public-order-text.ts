...
export const EXPANSION_PUBLIC_ORDER_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_exp_po_martial_law: {
    ...
    body: 'With civil order collapsing and the watch powerless to contain the unrest, your generals urge you to declare martial law. Soldiers would patrol every street and curfew would be absolute. The merchants warn it will kill trade; the commoners fear tyranny. Word comes most urgently from {region}.',
    choices: {
