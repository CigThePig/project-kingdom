...
export const EXPANSION_CULTURE_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_exp_cul_preservation_crisis: {
    ...
    body: 'A growing tide of foreign customs threatens to erode the kingdom\'s ancestral traditions beyond recovery. The elders plead for intervention, while merchants argue that cultural exchange brings prosperity. The crown must decide what the realm\'s identity shall become.',
    choices: {
  ...
  evt_exp_cul_literary_movement: {
    ...
    body: 'Scholars and monks across the realm have begun producing a flourishing body of written works, from theological treatises to historical chronicles. The clergy petition for scriptoriums to preserve this knowledge, while others suggest a royal chronicle would better serve the crown\'s legacy.',
    choices: {
  ...
  evt_exp_cul_winter_stories: {
    ...
    body: 'As the long nights of winter settle over the realm, the people gather around hearth fires to share tales of heroes and ancestors. Hosting a royal gathering in the great hall would honor this tradition, drawing bards and chroniclers from every corner of the kingdom.',
    choices: {
  ...
  evt_exp_cul_assimilation_pressure: {
    ...
    body: 'Emissaries from the Southern Empire have made it plain that continued hostility will persist unless the kingdom adopts their customs and courtly protocols. Resistance will be costly but preserves sovereignty, while accommodation risks the realm\'s very identity.',
    choices: {
