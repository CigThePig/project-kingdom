...
export const EXPANSION_CULTURE_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_exp_cul_monument_foundation: {
    ...
    body: 'The master masons have presented plans for a monument to commemorate the kingdom\'s founding lineage. The design ranges from a towering granite obelisk to a modest stone memorial, each carrying different implications for the treasury and our cultural standing.',
    choices: {
