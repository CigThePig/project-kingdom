...
export const CONDITION_EVENT_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_cond_drought_severe: {
    ...
    body: 'The earth is cracked and barren across {region}. Entire villages have been abandoned as their wells ran dry. What little water remains is fought over in the streets. The kingdom faces a crisis of survival.',
    choices: {
  ...
  evt_cond_plague_moderate: {
    ...
    body: 'The disease has spread beyond any hope of containment. Market squares stand empty, churches overflow with the dying, and the stench of sickness hangs over every settlement of {region}. The kingdom reels under the weight of the pestilence.',
    choices: {
  ...
  evt_cond_plague_severe: {
    ...
    body: 'Death stalks every corner of {region}. Entire villages have been wiped out, trade has ground to a halt, and the living struggle to bury the dead. Panic and despair threaten to tear apart what the plague does not claim.',
    choices: {
  ...
  evt_cond_plague_escalation: {
    ...
    body: 'Despite all efforts, the plague intensifies across {region}. What was once containable has mutated into something far deadlier. Physicians report new symptoms, higher mortality, and faster transmission. Drastic action may be the only recourse.',
    choices: {
  ...
  evt_cond_famine_moderate: {
    ...
    body: 'Hunger has become the constant companion of the common folk across {region}. Granaries are nearly bare, bread prices have soared beyond reach, and desperate families scour the countryside for anything edible. Without intervention, starvation will claim many lives.',
    choices: {
