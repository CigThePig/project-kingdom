...
export const EXPANSION_FOLLOWUP_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_fu_drought_wasteland: {
    ...
    body: 'The abandoned region has not recovered. Dry wells, cracked earth, empty villages — the crown must decide whether to invest in reclaiming the land or cede it to the desert. Word comes most urgently from {region}.',
  ...
  evt_fu_merchant_water_reprisal: {
    ...
    body: 'The seized water rights have bled merchant trust. A delegation demands compensation for the commandeered stores before trade resumes. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_burned_quarters_rebuild: {
    ...
    body: 'The quarters we put to the torch still stand empty. Commoners want reconstruction funded; others say the ash should serve as a warning. Word comes most urgently from {region}.',
  ...
  evt_fu_plague_worsens: {
    ...
    body: 'Prayer has not stayed the plague. Fresh reports speak of whole villages fallen silent. The crown must act. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_plague_wasteland: {
    ...
    body: 'Where we accepted the fate of the dying, only a wasteland remains. Settlers could be called back, or the land left to rot. Word comes most urgently from {region}.',
  ...
  evt_fu_exodus_refugee_crisis: {
    ...
    body: 'The plague exodus has massed at the borders of safer provinces. We must house them or turn them away. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_martial_law_aftermath: {
    ...
    body: 'Soldiers remain in the streets long after the plague broke. The people want normalcy; the generals advise caution. Word comes most urgently from {region}.',
  ...
  evt_fu_famine_ration_riot: {
    ...
    body: 'Strict rationing has broken down. Crowds storm the granaries. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_amnesty_banditry_return: {
    ...
    body: 'The amnesty held only as long as the purse. Fresh raids stalk the outer roads. Word comes most urgently from {region}.',
    choices: { recommit_patrols: 'Recommit Patrols', cut_losses: 'Cut the Losses' },
  },
  evt_fu_lawless_outer_region: {
    title: 'Lawless Province',
    body: 'Abandoned to itself, the outer region has found its own lords. The crown\'s writ runs only to the border. Word comes most urgently from {region}.',
  ...
  evt_fu_coopted_lords_demand_more: {
    ...
    body: 'Grown fat on royal favor, the lords we bought return for a second helping. Refusal will be taken as betrayal. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_corruption_entrenched: {
    ...
    body: 'What we tolerated has become the order of things. Tribunal or surrender — those are the remaining options. Word comes most urgently from {region}.',
  ...
  evt_fu_martial_law_backlash: {
    ...
    body: 'Dissenters have coalesced against the occupation. The streets are quieter, but quieter is not peaceful. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_rebel_accord_unravels: {
    ...
    body: 'The terms we agreed with the rebels are being read in a dozen contradictory ways. Either we honor every clause or we tear the page. Word comes most urgently from {region}.',
  ...
  evt_fu_syndicate_protection_fees: {
    ...
    body: 'The bosses we bribed now mail invoices to honest merchants. It is not yet extortion, they say — it is civic rent. Word comes most urgently from {region}.',
  ...
  evt_fu_criminal_shadow_state: {
    ...
    body: 'The ceded ports answer to a second crown now. Every entering ship pays that crown first. Word comes most urgently from {region}.',
  ...
  evt_fu_factions_see_through: {
    ...
    body: 'Playing guild and noble against each other worked — until both realized the game. Now both want a reckoning. Word comes most urgently from {region}.',
  ...
  evt_fu_social_order_revolt: {
    ...
    body: 'Commoners denied their demands have risen. The guard shudders; the nobility demands iron. Word comes most urgently from {region}.',
  ...
  evt_fu_token_concessions_backfire: {
    ...
    body: 'The small reforms proved the crown could bend. Now the commons want the crown to bend further. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_reform_martyrs: {
    ...
    body: 'Suppressing the reform movement cost lives the people now name. Acknowledging or denying those dead will shape the next months. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_cultural_drift_backlash: {
    ...
    body: 'The cultural reforms have unsettled the old orders. Sermons, pamphlets, whisper campaigns — the backlash is organised. Word comes most urgently from {region}.',
  ...
  evt_fu_suppression_diaspora_unrest: {
    ...
    body: 'Those we suppressed flee to sympathetic neighbours and sympathetic hills. The refuge terms will decide whether they come home. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_assimilation_standoff: {
    ...
    body: 'Refused, the neighbour\'s pressure has hardened into a standoff. Either we hold the line or we sue for terms. Dispatches from {region} corroborate what first reached the court through {neighbor}.',
    choices: { hold_the_line: 'Hold the Line', offer_terms: 'Offer Terms' },
  },
  evt_fu_integration_fifth_column: {
    title: 'A Fifth Column Among Us',
    body: 'The agents of partial integration proved agents of something else. Purge or turn, a choice of espionage. Word comes most urgently from {region}.',
  ...
  evt_fu_price_freeze_shortages: {
    ...
    body: 'The freeze holds — and so do the empty shelves. Enforcement or repeal, either answer costs. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_market_crash_bread_riots: {
    ...
    body: 'Letting the market correct has corrected us. The bread queues are now bread riots. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_counterfeit_underground_revenge: {
    ...
    body: 'Those we executed left heirs. Underground mints stamp new coin in the old shapes. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_royal_stamp_fraud: {
    ...
    body: 'The stamps we issued now travel on false coin too. The forgers work from inside the mint. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_dual_practice_schism: {
    ...
    body: 'What we called tolerance has congealed into two churches. Either we force a single rite or watch the split become permanent. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_underground_reformers: {
    ...
    body: 'Tradition restored from the pulpit; heresy restored in basements. The reformers have not gone — only gone dark. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_schism_reformer_revolt: {
    ...
    body: 'Backing orthodoxy sent the reformers to arms. Their council meets in the open air and names itself sovereign. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_schism_parallel_churches: {
    ...
    body: 'Recognising both confessions has made two churches. They now levy tithes in the same villages. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_doctrine_enforcement_blowback: {
    ...
    body: 'Priests refuse the edict; some bishops refuse their oaths. The crown must soften or prosecute. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_coexistence_fractures: {
    ...
    body: 'Allowed to coexist, the confessions have started burning each other\'s books. The kingdom cannot stay neutral. Word comes most urgently from {region}.',
  ...
  evt_fu_state_religion_persecution: {
    ...
    body: 'Imposing the state religion has turned into systematic persecution. Halt the purges or deepen the inquiry. Word comes most urgently from {region}.',
  ...
  evt_fu_pluralism_splinter_sects: {
    ...
    body: 'Pluralism did not stop at two faiths. Splinter sects multiply faster than the clergy can count. Word comes most urgently from {region}.',
  ...
  evt_fu_secularization_backlash: {
    ...
    body: 'Stripping the church of civic seats has united clergy and commons against the reform. Roll it back or hold fast. Word comes most urgently from {region}.',
  ...
  evt_fu_comet_heresy_spreads: {
    ...
    body: 'Forbidden speculation went where forbidden speech goes — underground, and out through every backroom. A new sect names the comet its prophet. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_marriage_dynastic_friction: {
    ...
    body: 'The dynastic marriage is stable on paper and tense at court. The in-laws pressure for real power. The {class_plural} are watching every move of the court. Dispatches from {region} corroborate what first reached the court through {neighbor}.',
  ...
  evt_fu_exiled_pretender_returns: {
    ...
    body: 'The pension ran out — or was never the point. The pretender is back, with new allies. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_succession_factions_war: {
    ...
    body: 'Playing the factions has birthed a small war in the capital. Either the crown takes a side, or the crown brokers peace. Word comes most urgently from {region}.',
  ...
  evt_fu_merit_heir_noble_backlash: {
    ...
    body: 'Merit chose the heir. Blood objects. The lords demand concessions or a reversal. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_authority_rebellion: {
    ...
    body: 'Asserting royal authority during the crisis cost consent. Open revolt follows unless a charter is granted. Word comes most urgently from {region}.',
  ...
  evt_fu_charter_implementation: {
    ...
    body: 'The Charter is on parchment. It must now be read, interpreted, enforced. Either by the letter or by royal nuance. Word comes most urgently from {region}.',
  ...
  evt_fu_purge_court_paralysis: {
    ...
    body: 'With the inner circle gone, decisions wait for seats to be filled. Recall exiles or elevate loyalists. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_mercy_emboldens_plot: {
    ...
    body: 'The pardoned conspirators did not repent. A second plot stirs in the same rooms. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_purge_officer_shortage: {
    ...
    body: 'The conspirators are gone and so are most of the experienced commanders. Ranks need filling, fast. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_bribed_officers_ask_more: {
    ...
    body: 'The officer corps we bought now presents a larger bill. Either the purse grows or the loyalty breaks. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
    choices: { raise_the_purse: 'Raise the Purse', hold_the_line: 'Hold the Line' },
  },
  evt_fu_ringleader_martyrs: {
    title: 'Ringleaders, Martyred',
    body: 'Isolated and executed, the ringleaders have become the stuff of ballads. Posthumous pardons, or a harder narrative? The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_officer_cabal: {
    ...
    body: 'Negotiation with the officers produced a quiet cabal — loyal on paper, loyal to themselves in practice. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_merchant_boycott: {
    ...
    body: 'The merchants we requisitioned from have closed their doors. The army\'s supply chain is choking. Word comes most urgently from {region}.',
    choices: { pay_the_backtax: 'Pay the Back-tax', force_the_trade: 'Force the Trade' },
  },
  evt_fu_starving_garrison: {
    title: 'A Garrison Starves',
    body: 'Rationing to breaking point, a garrison now eats its horses. Relief or retreat. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_field_equipment_catastrophe: {
    ...
    body: 'Pushing through with failing gear has cost a company its arms. The armoury must answer — or the unit dissolves. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_estate_seizure_lawsuit: {
    ...
    body: 'The requisitioned estate\'s heir has sued in the high court. The crown must pay or quash. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_seized_granaries_noble_revolt: {
    ...
    body: 'The granaries we opened without their leave have made the lords revolt. Return the stores, or stand firm. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_famine_descends_into_riot: {
    ...
    body: 'Appeals for calm fed only hunger. The riot has come. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_noble_contribution_resistance: {
    ...
    body: 'The contribution we demanded has been refused in council. Seize it or waive it. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_neglected_works_collapse: {
    ...
    body: 'Suspended spending had consequences. A bridge, a wall, or a granary has gone — take your pick; they did. Word comes most urgently from {region}.',
  ...
  evt_fu_arrests_purge_pushback: {
    ...
    body: 'The preemptive arrests have produced a noble faction demanding releases. Halve the list — or double it. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_double_agent_compromised: {
    ...
    body: 'One of our planted agents has been made. Extract them at cost, or burn them and keep the network. Word comes most urgently from {region}.',
  ...
  evt_fu_closed_border_smuggling: {
    ...
    body: 'The border closure has bred professional smugglers. Legitimise controlled exits, or harden the patrols. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_exodus_brain_drain: {
    ...
    body: 'Letting dissenters leave cost the kingdom its physicians, scribes, and mint clerks. Incentivise return or seal tighter. Word comes most urgently from {region}.',
  ...
  evt_fu_curfew_mass_defiance: {
    ...
    body: 'The curfew produced crowds that deliberately break it. Either it ends, or it is enforced with blood. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_peacekeeper_overreach: {
    ...
    body: 'Patrols deployed for order have crossed into brutality. Court-martial the officers, or defend the guards. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_patrol_brutality_complaint: {
    ...
    body: 'A commoner delegation brings a register of patrol abuses. Reassign or dismiss. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_labor_reform_backlash: {
    ...
    body: 'The reforms pleased few. Broaden them, or soften them. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_crushed_movement_underground: {
    ...
    body: 'Crushed above ground, the revolutionary guild moves below. Hunt or amnesty. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_guild_compromise_drift: {
    ...
    body: 'The compromise text grows unrecognisable as each side rereads it. Honor or revise. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_commandeered_stores_noble_strike: {
    ...
    body: 'The lords refuse to sit council until the grain is returned. Return it, or seize more. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_spoiled_grain_sickness: {
    ...
    body: 'The remains we distributed are making the poor sick. Healers are needed; quarantine too. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_noble_estate_razed: {
    ...
    body: 'Crushing the uprising cost an estate and a line. The survivors want compensation; the commoners want land. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_amnesty_cabal_reforms: {
    ...
    body: 'Those we pardoned return with a parchment. They want the concessions codified; the court wants them silenced. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_force_crackdown_legacy: {
    ...
    body: 'The commoners remember who the guard cut down. A public apology or the erasure of memorials — nothing neutral. Word comes most urgently from {region}.',
  ...
  evt_fu_mob_rule_spreads: {
    ...
    body: 'Letting the mob decide has spread the habit. Other quarters hold their own tribunals now. Crush or codify. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_civilian_authority_falters: {
    ...
    body: 'Trusting civilian courts during the crisis left them overrun. Restore military patrol, or back the judges with gold. Word comes most urgently from {region}.',
  ...
  evt_fu_pardon_emboldens_graft: {
    ...
    body: 'The pardoned grafters now regard the tribunal as a formality. Launch a fresh one, or legalise the fees. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_press_smuggled_in: {
    ...
    body: 'We banned the device. It arrived anyway. Seize every press, or regulate instead. Word comes most urgently from {region}.',
  ...
  evt_fu_abandoned_convoy_outrage: {
    ...
    body: 'Cutting losses cost merchants their goods and their trust in the crown. Reimburse, or decline. Word comes most urgently from {region}.',
  ...
  evt_fu_scorched_earth_famine: {
    ...
    body: 'Our own borderlanders are starving in the scorched districts. Import, or leave them to the winter. The {class_plural} are watching every move of the court. Word comes most urgently from {region}.',
  ...
  evt_fu_surrender_terms_harsh: {
    ...
    body: 'Suing for peace produced an indemnity the treasury cannot bear — or the crown can reopen the war. Dispatches from {region} corroborate what first reached the court through {neighbor}.',
