...
export const EXPANSION_FOLLOWUP_TEXT: Record<string, EventTextEntry> = {
  ...
  evt_exp_fu_food_overfishing: {
    ...
    body: 'The fishing boom has been too successful. Fishermen off the coast of {region} report dwindling catches and smaller fish, suggesting the {terrain} waters are being overfished. Unless limits are imposed, the fishery may collapse entirely.',
    choices: {
  ...
  evt_exp_fu_mil_fortress_garrison: {
    ...
    body: 'The newly constructed border fortresses along {region} have been garrisoned and provisioned. Their presence has already deterred several incursions, and local villages report feeling safer than they have in years.',
    choices: {
  ...
  evt_exp_fu_dip_refugee_integration: {
    ...
    body: 'The refugees welcomed into {region} are settling in and beginning to establish themselves. Some locals grumble about competition for work and housing, while others appreciate the newcomers\' industriousness.',
    choices: {
  ...
  evt_exp_fu_env_levee_success: {
    ...
    body: 'The new levees and dams along {region} have been tested by the spring rains and held firm. The river valley that was devastated last season has been spared, and farmers are planting with renewed confidence.',
    choices: {
  ...
  evt_exp_fu_env_fire_recovery: {
    ...
    body: 'The wildfire has passed, leaving a swath of charred landscape across {region}. The land will recover, but the crown must decide how — replanting the forest, converting the cleared ground to farmland, or simply letting nature take its course.',
    choices: {
  ...
  evt_exp_fu_env_mine_reopening: {
    ...
    body: 'Safety improvements at the collapsed mine in {region} are complete, and the engineers have declared the site ready for operations. The workers are eager to return, though some families still fear another collapse.',
    choices: {
  ...
  evt_exp_fu_env_logging_ban_impact: {
    ...
    body: 'The logging ban has protected the forests, but the loggers and their families are suffering. Unemployment has risen in the timber-dependent villages of {region}, and there are calls for compensation or alternative employment.',
    choices: {
  ...
  evt_exp_fu_env_mining_wealth: {
    ...
    body: 'The crown mining operation at the newly discovered vein is producing excellent yields. Iron and copper flow into the treasury, and {region} is beginning to develop around the mining {settlement}.',
    choices: {
      acknowledge: 'Acknowledge the Report',
    },
  },
  ...
  evt_exp_fu_cul_language_resistance: {
    ...
    body: 'The decree enforcing a single official language has met fierce resistance in {region}, where older linguistic traditions run deep. Petitions and protests demand recognition of local tongues, and compliance has been poor.',
    choices: {
  ...
  evt_exp_fu_reg_resource_boom: {
    ...
    body: 'The crown monopoly on the newly discovered resources has begun generating significant revenue. {region} is developing rapidly as workers and merchants flock to the area.',
    choices: {
  ...
  evt_exp_fu_reg_infrastructure_complete: {
    ...
    body: 'The approved infrastructure project has been completed on schedule. New roads, bridges, and public buildings serve {region}, and the improved connectivity is already stimulating local trade and settlement.',
    choices: {
      acknowledge: 'Acknowledge the Completion',
    },
  },
  evt_exp_fu_reg_new_governor: {
    ...
    body: 'With the corrupt governor removed, {region} requires new leadership. The choice of replacement will signal the crown\'s priorities — loyalty, local knowledge, or direct control.',
    choices: {
  ...
  evt_exp_fu_reg_hero_legend: {
    ...
    body: 'The royal recognition of the local hero has elevated them to legendary status. Songs are sung in their honor, and {region} takes pride in producing such a celebrated figure. Morale and loyalty are strengthened.',
    choices: {
  ...
  evt_exp_fu_kgd_centralization_tension: {
    ...
    body: 'The administrative centralization has produced efficiency gains in the capital, but provincial leaders chafe under the loss of autonomy. {region} and its peers threaten non-cooperation unless some measure of local governance is restored.',
    choices: {
  ...
  evt_fu_drought_wasteland: {
    ...
    body: 'The abandoned lands of {region} have not recovered. Dry wells, cracked earth, empty villages — the crown must decide whether to invest in reclaiming the land or cede it to the desert.',
  ...
  evt_fu_merchant_water_reprisal: {
    ...
    body: 'The seized water rights have bled merchant trust across {region}. A delegation demands compensation for the commandeered stores before trade resumes.',
  ...
  evt_fu_burned_quarters_rebuild: {
    ...
    body: 'The quarters we put to the torch still stand empty across {region}. Commoners want reconstruction funded; others say the ash should serve as a warning.',
  ...
  evt_fu_plague_worsens: {
    ...
    body: 'Prayer has not stayed the plague. Fresh reports speak of whole villages across {region} fallen silent. The crown must act.',
  ...
  evt_fu_plague_wasteland: {
    ...
    body: 'Where we accepted the fate of the dying in {region}, only a wasteland remains. Settlers could be called back, or the land left to rot.',
  ...
  evt_fu_exodus_refugee_crisis: {
    ...
    body: 'The plague exodus has massed at the borders of {region}. We must house them or turn them away.',
  ...
  evt_fu_martial_law_aftermath: {
    ...
    body: 'Soldiers remain in the streets of {region} long after the plague broke. The people want normalcy; the generals advise caution.',
  ...
  evt_fu_famine_ration_riot: {
    ...
    body: 'Strict rationing has broken down across {region}. Crowds storm the granaries.',
  ...
  evt_fu_amnesty_banditry_return: {
    ...
    body: 'The amnesty held only as long as the purse. Fresh raids stalk the outer roads of {region}.',
    choices: { recommit_patrols: 'Recommit Patrols', cut_losses: 'Cut the Losses' },
  },
  evt_fu_lawless_outer_region: {
    title: 'Lawless Province',
    body: 'Abandoned to itself, {region} has found its own lords. The crown\'s writ runs only to the border.',
  ...
  evt_fu_coopted_lords_demand_more: {
    ...
    body: 'Grown fat on royal favor, the lords we bought in {region} return for a second helping. Refusal will be taken as betrayal.',
  ...
  evt_fu_corruption_entrenched: {
    ...
    body: 'What we tolerated has become the order of things across {region}. Tribunal or surrender — those are the remaining options.',
  ...
  evt_fu_martial_law_backlash: {
    ...
    body: 'Dissenters have coalesced against the occupation of {region}. The streets are quieter, but quieter is not peaceful.',
  ...
  evt_fu_rebel_accord_unravels: {
    ...
    body: 'The terms we agreed with the rebels of {region} are being read in a dozen contradictory ways. Either we honor every clause or we tear the page.',
  ...
  evt_fu_syndicate_protection_fees: {
    ...
    body: 'The bosses we bribed now mail invoices to honest merchants across {region}. It is not yet extortion, they say — it is civic rent.',
  ...
  evt_fu_criminal_shadow_state: {
    ...
    body: 'The ceded ports of {region} answer to a second crown now. Every entering ship pays that crown first.',
  ...
  evt_fu_factions_see_through: {
    ...
    body: 'Playing guild and noble against each other across {region} worked — until both realized the game. Now both want a reckoning.',
  ...
  evt_fu_social_order_revolt: {
    ...
    body: 'Commoners denied their demands have risen across {region}. The guard shudders; the nobility demands iron.',
  ...
  evt_fu_token_concessions_backfire: {
    ...
    body: 'The small reforms proved the crown could bend. Now the commons across {region} want the crown to bend further.',
  ...
  evt_fu_reform_martyrs: {
    ...
    body: 'Suppressing the reform movement cost lives the people across {region} now name. Acknowledging or denying those dead will shape the next months.',
  ...
  evt_fu_cultural_drift_backlash: {
    ...
    body: 'The cultural reforms have unsettled the old orders across {region}. Sermons, pamphlets, whisper campaigns — the backlash is organised.',
  ...
  evt_fu_suppression_diaspora_unrest: {
    ...
    body: 'Those we suppressed in {region} flee to sympathetic neighbours and sympathetic hills. The refuge terms will decide whether they come home.',
  ...
  evt_fu_assimilation_standoff: {
    ...
    body: 'Refused, the pressure from {neighbor_short} has hardened into a standoff along the marches of {region}. Either we hold the line or we sue for terms.',
    choices: { hold_the_line: 'Hold the Line', offer_terms: 'Offer Terms' },
  },
  evt_fu_integration_fifth_column: {
    title: 'A Fifth Column Among Us',
    body: 'The agents of partial integration proved agents of something else, rooted deep in {region}. Purge or turn, a choice of espionage.',
  ...
  evt_fu_price_freeze_shortages: {
    ...
    body: 'The freeze holds — and so do the empty shelves across {region}. Enforcement or repeal, either answer costs.',
  ...
  evt_fu_market_crash_bread_riots: {
    ...
    body: 'Letting the market correct has corrected us. The bread queues across {region} are now bread riots.',
  ...
  evt_fu_counterfeit_underground_revenge: {
    ...
    body: 'Those we executed left heirs. Underground mints across {region} stamp new coin in the old shapes.',
  ...
  evt_fu_royal_stamp_fraud: {
    ...
    body: 'The stamps we issued now travel on false coin too, passing through markets across {region}. The forgers work from inside the mint.',
  ...
  evt_fu_dual_practice_schism: {
    ...
    body: 'What we called tolerance has congealed into two churches across {region}. Either we force a single rite or watch the split become permanent.',
  ...
  evt_fu_underground_reformers: {
    ...
    body: 'Tradition restored from the pulpit; heresy restored in basements across {region}. The reformers have not gone — only gone dark.',
  ...
  evt_fu_schism_reformer_revolt: {
    ...
    body: 'Backing orthodoxy sent the reformers of {region} to arms. Their council meets in the open air and names itself sovereign.',
  ...
  evt_fu_schism_parallel_churches: {
    ...
    body: 'Recognising both confessions has made two churches. They now levy tithes in the same villages across {region}.',
  ...
  evt_fu_doctrine_enforcement_blowback: {
    ...
    body: 'Priests across {region} refuse the edict; some bishops refuse their oaths. The crown must soften or prosecute.',
  ...
  evt_fu_coexistence_fractures: {
    ...
    body: 'Allowed to coexist, the confessions of {region} have started burning each other\'s books. The kingdom cannot stay neutral.',
  ...
  evt_fu_state_religion_persecution: {
    ...
    body: 'Imposing the state religion has turned into systematic persecution across {region}. Halt the purges or deepen the inquiry.',
  ...
  evt_fu_pluralism_splinter_sects: {
    ...
    body: 'Pluralism did not stop at two faiths. Splinter sects across {region} multiply faster than the clergy can count.',
  ...
  evt_fu_secularization_backlash: {
    ...
    body: 'Stripping the church of civic seats has united clergy and commons across {region} against the reform. Roll it back or hold fast.',
  ...
  evt_fu_comet_heresy_spreads: {
    ...
    body: 'Forbidden speculation went where forbidden speech goes — underground, and out through every backroom in {region}. A new sect names the comet its prophet.',
  ...
  evt_fu_marriage_dynastic_friction: {
    ...
    body: 'The dynastic marriage with {neighbor_short} is stable on paper and tense at court, with contested estates across {region}. The in-laws pressure for real power.',
  ...
  evt_fu_exiled_pretender_returns: {
    ...
    body: 'The pension ran out — or was never the point. The pretender is back in {region}, with new allies.',
  ...
  evt_fu_succession_factions_war: {
    ...
    body: 'Playing the factions has birthed a small war in the capital that now bleeds into {region}. Either the crown takes a side, or the crown brokers peace.',
  ...
  evt_fu_merit_heir_noble_backlash: {
    ...
    body: 'Merit chose the heir. Blood objects. The lords of {region} demand concessions or a reversal.',
  ...
  evt_fu_authority_rebellion: {
    ...
    body: 'Asserting royal authority during the crisis cost consent across {region}. Open revolt follows unless a charter is granted.',
  ...
  evt_fu_charter_implementation: {
    ...
    body: 'The Charter is on parchment. It must now be read, interpreted, enforced across {region}. Either by the letter or by royal nuance.',
  ...
  evt_fu_purge_court_paralysis: {
    ...
    body: 'With the inner circle gone, decisions wait for seats to be filled and writs to reach {region}. Recall exiles or elevate loyalists.',
  ...
  evt_fu_mercy_emboldens_plot: {
    ...
    body: 'The pardoned conspirators did not repent. A second plot stirs in the same rooms, with safe houses across {region}.',
  ...
  evt_fu_purge_officer_shortage: {
    ...
    body: 'The conspirators are gone and so are most of the experienced commanders across {region}. Ranks need filling, fast.',
  ...
  evt_fu_bribed_officers_ask_more: {
    ...
    body: 'The officer corps we bought in {region} now presents a larger bill. Either the purse grows or the loyalty breaks.',
    choices: { raise_the_purse: 'Raise the Purse', hold_the_line: 'Hold the Line' },
  },
  evt_fu_ringleader_martyrs: {
    title: 'Ringleaders, Martyred',
    body: 'Isolated and executed, the ringleaders have become the stuff of ballads across {region}. Posthumous pardons, or a harder narrative?',
  ...
  evt_fu_officer_cabal: {
    ...
    body: 'Negotiation with the officers of {region} produced a quiet cabal — loyal on paper, loyal to themselves in practice.',
  ...
  evt_fu_merchant_boycott: {
    ...
    body: 'The merchants we requisitioned from across {region} have closed their doors. The army\'s supply chain is choking.',
    choices: { pay_the_backtax: 'Pay the Back-tax', force_the_trade: 'Force the Trade' },
  },
  evt_fu_starving_garrison: {
    title: 'A Garrison Starves',
    body: 'Rationing to breaking point, a garrison in {region} now eats its horses. Relief or retreat.',
  ...
  evt_fu_field_equipment_catastrophe: {
    ...
    body: 'Pushing through with failing gear has cost a company its arms in the field of {region}. The armoury must answer — or the unit dissolves.',
  ...
  evt_fu_estate_seizure_lawsuit: {
    ...
    body: 'The heir of the requisitioned estate in {region} has sued in the high court. The crown must pay or quash.',
  ...
  evt_fu_seized_granaries_noble_revolt: {
    ...
    body: 'The granaries we opened without their leave have made the lords of {region} revolt. Return the stores, or stand firm.',
  ...
  evt_fu_famine_descends_into_riot: {
    ...
    body: 'Appeals for calm fed only hunger. The riot has come to {region}.',
  ...
  evt_fu_noble_contribution_resistance: {
    ...
    body: 'The contribution we demanded of the lords of {region} has been refused in council. Seize it or waive it.',
  ...
  evt_fu_neglected_works_collapse: {
    ...
    body: 'Suspended spending had consequences across {region}. A bridge, a wall, or a granary has gone — take your pick; they did.',
  ...
  evt_fu_arrests_purge_pushback: {
    ...
    body: 'The preemptive arrests across {region} have produced a noble faction demanding releases. Halve the list — or double it.',
  ...
  evt_fu_double_agent_compromised: {
    ...
    body: 'One of our planted agents in {region} has been made. Extract them at cost, or burn them and keep the network.',
  ...
  evt_fu_closed_border_smuggling: {
    ...
    body: 'The border closure has bred professional smugglers along the edges of {region}. Legitimise controlled exits, or harden the patrols.',
  ...
  evt_fu_exodus_brain_drain: {
    ...
    body: 'Letting dissenters leave cost {region} its physicians, scribes, and mint clerks. Incentivise return or seal tighter.',
  ...
  evt_fu_curfew_mass_defiance: {
    ...
    body: 'The curfew has produced crowds across {region} that deliberately break it. Either it ends, or it is enforced with blood.',
  ...
  evt_fu_peacekeeper_overreach: {
    ...
    body: 'Patrols deployed for order across {region} have crossed into brutality. Court-martial the officers, or defend the guards.',
  ...
  evt_fu_patrol_brutality_complaint: {
    ...
    body: 'A commoner delegation from {region} brings a register of patrol abuses. Reassign or dismiss.',
  ...
  evt_fu_labor_reform_backlash: {
    ...
    body: 'The reforms pleased few across {region}. Broaden them, or soften them.',
  ...
  evt_fu_crushed_movement_underground: {
    ...
    body: 'Crushed above ground, the revolutionary guild moves below the streets of {region}. Hunt or amnesty.',
  ...
  evt_fu_guild_compromise_drift: {
    ...
    body: 'The compromise text grows unrecognisable as each side rereads it in the guildhalls of {region}. Honor or revise.',
  ...
  evt_fu_commandeered_stores_noble_strike: {
    ...
    body: 'The lords of {region} refuse to sit council until the grain is returned. Return it, or seize more.',
  ...
  evt_fu_spoiled_grain_sickness: {
    ...
    body: 'The remains we distributed across {region} are making the poor sick. Healers are needed; quarantine too.',
  ...
  evt_fu_noble_estate_razed: {
    ...
    body: 'Crushing the uprising cost an estate and a line in {region}. The survivors want compensation; the commoners want land.',
  ...
  evt_fu_amnesty_cabal_reforms: {
    ...
    body: 'Those we pardoned in {region} return with a parchment. They want the concessions codified; the court wants them silenced.',
  ...
  evt_fu_force_crackdown_legacy: {
    ...
    body: 'The commoners of {region} remember who the guard cut down. A public apology or the erasure of memorials — nothing neutral.',
  ...
  evt_fu_mob_rule_spreads: {
    ...
    body: 'Letting the mob decide has spread the habit across {region}. Other quarters hold their own tribunals now. Crush or codify.',
  ...
  evt_fu_civilian_authority_falters: {
    ...
    body: 'Trusting civilian courts during the crisis left them overrun across {region}. Restore military patrol, or back the judges with gold.',
  ...
  evt_fu_pardon_emboldens_graft: {
    ...
    body: 'The pardoned grafters of {region} now regard the tribunal as a formality. Launch a fresh one, or legalise the fees.',
  ...
  evt_fu_press_smuggled_in: {
    ...
    body: 'We banned the device. It arrived anyway in the cellars of {region}. Seize every press, or regulate instead.',
  ...
  evt_fu_abandoned_convoy_outrage: {
    ...
    body: 'Cutting losses cost merchants their goods and their trust in the crown, with the loudest fury in {region}. Reimburse, or decline.',
  ...
  evt_fu_scorched_earth_famine: {
    ...
    body: 'Our own borderlanders are starving in the scorched districts of {region}. Import, or leave them to the winter.',
  ...
  evt_fu_surrender_terms_harsh: {
    ...
    body: 'Suing for peace with {neighbor_short} produced an indemnity the treasury cannot bear, with ceded ground across {region} — or the crown can reopen the war.',
