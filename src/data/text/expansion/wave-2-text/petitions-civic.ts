...
export const EXPANSION_WAVE_2_PETITIONS_CIVIC_TEXT: Record<string, EventTextEntry> = {
  faction_req_w2_scholarly_society: {
    ...
    body: 'A circle of clerics and lay scholars has organized a learned society and asks royal recognition. They promise a flowering of letters; the practical-minded suggest the whole thing is a way to draw royal coin without royal oversight.',
    choices: {
  ...
  faction_req_w2_regional_lords_road: {
    ...
    body: 'Three regional lords have arrived with a joint petition: the old trade road through their holdings is failing, and they ask for royal coin to rebuild it. The benefit to travel is clear; the benefit to their private rents is clearer still.',
    choices: {
  ...
  faction_req_w2_displaced_peasants: {
    ...
    body: 'A column of peasants driven from their holdings by a new round of enclosures has arrived at the capital. They ask for crown land to settle. Their lords send riders demanding the runaways be returned at once.',
    choices: {
  ...
  faction_req_w2_foreign_envoy: {
    ...
    body: 'An envoy from a distant court has arrived unannounced and requests an audience. Protocol says wait; the envoy says urgent; the spymaster says interesting. You may grant the audience at once or make him cool his heels.',
    choices: {
