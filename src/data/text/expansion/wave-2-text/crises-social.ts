...
export const EXPANSION_WAVE_2_CRISES_SOCIAL_TEXT: Record<string, EventTextEntry> = {
  evt_exp_w2_food_riot_escalation: {
    ...
    body: 'The bread queues have become bread riots. In two market towns the granaries have been stormed; in a third the royal factor was beaten and left in the road. The city guard report that one more failed harvest will set the whole country alight.',
    choices: {
  ...
  evt_exp_w2_bonded_labor_revolt: {
    ...
    body: 'Bonded labourers on three of the great estates have downed their tools and begun to march toward the capital with a list of grievances. The lords demand the rebellion be broken; the reformers demand a hearing; both watch you closely.',
    choices: {
