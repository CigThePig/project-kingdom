...
export const EXPANSION_WAVE_2_CRISES_PHENOMENA_TEXT: Record<string, EventTextEntry> = {
  evt_exp_w2_strange_phenomenon: {
    ...
    body: 'For three nights running a pale light has walked the reed-fields outside a southern hamlet. The commons declare it a saint; the bishop suspects a trick; the scholars have asked permission to sit up with torches and notebooks.',
    choices: {
  ...
  evt_exp_w2_drought_escalation: {
    ...
    body: 'The summer has brought no rain. The rivers run low; the great mill-wheels stand still; the cattle are driven further each day to find water. The commons look to the sky and then to the palace.',
    choices: {
  ...
  evt_exp_w2_explored_ruins: {
    ...
    body: 'A landslide has opened an old doorway in the cliffs above a quarry. Behind it the workers found carved stones and a sealed inner chamber. The bishop wants it blessed; the masons want it stripped; the scholars want it dug open. None will wait.',
    choices: {
  ...
  evt_exp_w2_vassal_succession: {
    ...
    body: 'The old lord of a border fief has died and left two sons at odds. The elder has the law; the younger has the affection of the house guard and the local tenants. Whichever you confirm, the other will turn his face from the Crown.',
    choices: {
