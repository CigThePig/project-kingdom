...
export const EXPANSION_WAVE_2_CRISES_POLITICAL_TEXT: Record<string, EventTextEntry> = {
  evt_exp_w2_royal_scandal: {
    ...
    body: 'A rumour has broken loose in the capital: a matter of the royal household that ought never to have left the chamber. The ballads have already been written; the bishops are drafting stern homilies. Silence will not serve. The {class_plural} await the crown\'s reply.',
    choices: {
