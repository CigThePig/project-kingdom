...
export const EXPANSION_WAVE_2_CRISES_ORIGINAL_TEXT: Record<string, EventTextEntry> = {
  evt_exp_w2_comet_sighting: {
    title: 'A Great Comet Burns Over {region}',
    body: 'For a full week a great burning star has hung over {settlement} and the skies of {region} at dusk. The bishops whisper of omens; the commonfolk crowd the cathedral steps; the astronomers debate in quiet rooms. Every observer asks the same question: is this a sign of favour, or of judgement?',
    choices: {
