...
export const EVENT_POOL: EventDefinition[] = [
  ...
  {
    id: 'evt_abundant_harvest_surplus',
    severity: EventSeverity.Notable,
    category: EventCategory.Food,
    triggerConditions: [
      { type: 'food_above', threshold: 160 },
      { type: 'season_is', season: Season.Summer },
    ],
    weight: 0.9,
    chainId: null,
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'invest_in_granary_expansion', slotCost: 1, isFree: false },
      { choiceId: 'organize_food_trade_caravans', slotCost: 1, isFree: false },
      { choiceId: 'celebrate_abundance', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: false,
    relatedStorylineId: null,
  ...
  {
    id: 'evt_agricultural_innovation',
    severity: EventSeverity.Notable,
    category: EventCategory.Food,
    triggerConditions: [
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'implement_across_kingdom', slotCost: 1, isFree: false },
      { choiceId: 'trial_in_one_region', slotCost: 1, isFree: false },
      { choiceId: 'document_for_scholars', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: true,
    relatedStorylineId: null,
  ...
  {
    id: 'evt_autumn_stockpile_opportunity',
    severity: EventSeverity.Notable,
    category: EventCategory.Food,
    triggerConditions: [
      { type: 'season_is', season: Season.Autumn },
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'purchase_winter_grain_reserves', slotCost: 1, isFree: false },
      { choiceId: 'organize_community_preserving', slotCost: 1, isFree: false },
      { choiceId: 'trust_existing_stores', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: false,
    relatedStorylineId: null,
  ...
  },
  {
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'accept_bulk_purchase', slotCost: 1, isFree: false },
      { choiceId: 'negotiate_ongoing_supply', slotCost: 1, isFree: false },
      { choiceId: 'decline_offer', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Merchants,
    affectsRegion: false,
  ...
  {
    id: 'evt_military_foraging_campaign',
    severity: EventSeverity.Notable,
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'organize_military_hunts', slotCost: 1, isFree: false },
      { choiceId: 'forage_borderlands', slotCost: 1, isFree: false },
      { choiceId: 'reduce_military_rations', slotCost: 1, isFree: false },
    ],
  ...
  },
  {
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'clear_new_farmland', slotCost: 1, isFree: false },
      { choiceId: 'improve_existing_fields', slotCost: 1, isFree: false },
      { choiceId: 'rely_on_current_acreage', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: true,
    relatedStorylineId: null,
  ...
  },
  {
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'fund_peasant_proposals', slotCost: 1, isFree: false },
      { choiceId: 'approve_with_oversight', slotCost: 1, isFree: false },
      { choiceId: 'acknowledge_initiative', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: false,
    relatedStorylineId: null,
...
export const FOLLOW_UP_POOL: EventDefinition[] = [
  // --- Food Follow-ups (3) ---
  {
    id: 'evt_granary_expansion_complete',
    severity: EventSeverity.Informational,
    category: EventCategory.Food,
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'stockpile_for_winter', slotCost: 0, isFree: true },
      { choiceId: 'share_with_needy_regions', slotCost: 1, isFree: false },
    ],
    affectsClass: PopulationClass.Commoners,
    affectsRegion: false,
    relatedStorylineId: null,
  ...
  },
  {
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'reinvest_profits', slotCost: 1, isFree: false },
      { choiceId: 'distribute_foreign_goods', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Merchants,
    affectsRegion: false,
    relatedStorylineId: null,
  ...
  {
    id: 'evt_supply_agreement_renewal',
    severity: EventSeverity.Informational,
    category: EventCategory.Economy,
    triggerConditions: [{ type: 'always' }],
    weight: 1.0,
    ...
    chainNextDefinitionId: null,
    choices: [
      { choiceId: 'renew_agreement', slotCost: 1, isFree: false },
      { choiceId: 'renegotiate_terms', slotCost: 1, isFree: false },
      { choiceId: 'let_agreement_lapse', slotCost: 0, isFree: true },
    ],
    affectsClass: PopulationClass.Merchants,
    affectsRegion: false,
    affectsNeighbor: '__ANY__',
  ...
  },
  {
    ...
    affectsClass: PopulationClass.MilitaryCaste, affectsRegion: false, affectsNeighbor: '__HOSTILE__', relatedStorylineId: null,
    phase: 'any',
  },
  {
  ...
  },
  {
    ...
    affectsClass: PopulationClass.Commoners, affectsRegion: false, affectsNeighbor: '__HOSTILE__', relatedStorylineId: null,
    phase: 'any',
  },
  {
